...
const popularTags = [
  { _id: "1", name: "R", questions: 100 },
  { _id: "2", name: "Python", questions: 200 },
...
const RightSidebar = () => {
  return (
    <section className="pt-36 custom-scrollbar background-light900_dark200 light-border sticky right-0 top-0 h-screen flex flex-col w-[350px] overflow-y-auto border-l p-6 shadow-light-300 max-xl:hidden dark:shadow ">
      <div>
